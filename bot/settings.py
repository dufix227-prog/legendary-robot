...
DEFAULTS: dict[str, str] = {
    ...
    "award_min_bets": "5",               # награды капперам: минимум рассчитанных купонов в дивизионе
    "award_coins_champion": "3000",      # дым за 1 место среди капперов дивизиона
    "award_coins_top3": "1500",          # 2–3 место
    "award_coins_top10": "500",          # 4–10 место
    "risk_liability": "5000",            # риск: возможная выплата по одному исходу матча (×2 — «высокий»)
    "risk_one_sided_pct": "80",          # риск: доля денег на один исход
    "risk_min_stake": "1000",            # риск: доля считается от этой суммы ставок на матч
    "risk_whale_pct": "60",              # риск: один игрок дал такую долю денег на матч
}
